...
namespace HRMS.SQLServerDAL.applets
{
	...
	public partial class customerDAL : IcustomerDAL
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "applets_customer");
        }
        #endregion
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from applets_customer");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(HRMS.Model.applets.customerModel model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into applets_customer(");
            strSql.Append("title,cover,microcode,date)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(HRMS.Model.applets.customerModel model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update applets_customer set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from applets_customer ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
    			new SqlParameter("@id", SqlDbType.Int,4)
        ...
        /// 得到一个对象实体
        /// </summary>
        public HRMS.Model.applets.customerModel GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,cover,microcode,date from applets_customer ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
    			new SqlParameter("@id", SqlDbType.Int,4)      
            };
            ...
            HRMS.Model.applets.customerModel model = new HRMS.Model.applets.customerModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public HRMS.Model.applets.customerModel GetModel(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,cover,microcode,date from applets_customer ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
        ...
        /// 得到一个对象实体
        /// </summary>
        public HRMS.Model.applets.customerModel DataRowToModel(DataRow row)
        {
            HRMS.Model.applets.customerModel model = new HRMS.Model.applets.customerModel();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,title,cover,microcode,date ");
            strSql.Append(" FROM applets_customer ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,cover,microcode,date ");
            strSql.Append(" FROM applets_customer ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from applets_customer T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update applets_customer set "+ set);
            int rows = DbHelperSQL.ExecuteSql(strSql.ToString());
            if (rows > 0)
            {
                return true;
