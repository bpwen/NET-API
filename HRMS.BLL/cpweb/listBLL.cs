...
namespace HRMS.BLL.cpweb
{
	...
	/// cpweb_list
	/// </summary>
	public partial class listBLL
	{
        private readonly IlistDAL dal = DataAccess.CreatelistDAL();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public HRMS.Model.cpweb.listModel GetModelByCache(int id)
        {
            string CacheKey = "cpweb_listModel-" + id;
            ...
            return (HRMS.Model.cpweb.listModel)objModel;
        }
        
        public HRMS.Model.cpweb.listModel GetModelByCache(string strWhere)
        {
            string Array = "-,_,:,/,=,', ,.";
            ...
            string CacheKey = "cpweb_listModel-" + _strWhere;
            object objModel = HRMS.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.cpweb.listModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.cpweb.listModel> DataTableToList(DataTable dt)
        {
            List<HRMS.Model.cpweb.listModel> modelList = new List<HRMS.Model.cpweb.listModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HRMS.Model.cpweb.listModel model;
