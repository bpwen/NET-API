...
namespace HRMS.BLL.cpweb
{
	...
	/// cpweb_applytype
	/// </summary>
	public partial class applytypeBLL
	{
        private readonly IapplytypeDAL dal = DataAccess.CreateapplytypeDAL();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(HRMS.Model.cpweb.applytypeModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(HRMS.Model.cpweb.applytypeModel model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public HRMS.Model.cpweb.applytypeModel GetModel(int id)
        {
            return dal.GetModel(id);
        }
        
        public HRMS.Model.cpweb.applytypeModel GetModel(string strWhere)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public HRMS.Model.cpweb.applytypeModel GetModelByCache(int id)
        {
            string CacheKey = "cpweb_applytypeModel-" + id;
            ...
            return (HRMS.Model.cpweb.applytypeModel)objModel;
        }
        
        public HRMS.Model.cpweb.applytypeModel GetModelByCache(string strWhere)
        {
            string Array = "-,_,:,/,=,', ,.";
            ...
            string CacheKey = "cpweb_applytypeModel-" + _strWhere;
            object objModel = HRMS.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.cpweb.applytypeModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.cpweb.applytypeModel> DataTableToList(DataTable dt)
        {
            List<HRMS.Model.cpweb.applytypeModel> modelList = new List<HRMS.Model.cpweb.applytypeModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HRMS.Model.cpweb.applytypeModel model;
