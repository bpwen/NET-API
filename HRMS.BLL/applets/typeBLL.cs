...
namespace HRMS.BLL.applets
{
	...
	/// applets_type
	/// </summary>
	public partial class typeBLL
	{
        private readonly ItypeDAL dal = DataAccess.CreatetypeDAL();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(HRMS.Model.applets.typeModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(HRMS.Model.applets.typeModel model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public HRMS.Model.applets.typeModel GetModel(int id)
        {
            return dal.GetModel(id);
        }
        
        public HRMS.Model.applets.typeModel GetModel(string strWhere)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public HRMS.Model.applets.typeModel GetModelByCache(int id)
        {
            string CacheKey = "applets_typeModel-" + id;
            ...
            return (HRMS.Model.applets.typeModel)objModel;
        }
        
        public HRMS.Model.applets.typeModel GetModelByCache(string strWhere)
        {
            string Array = "-,_,:,/,=,', ,.";
            ...
            string CacheKey = "applets_typeModel-" + _strWhere;
            object objModel = HRMS.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.applets.typeModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.applets.typeModel> DataTableToList(DataTable dt)
        {
            List<HRMS.Model.applets.typeModel> modelList = new List<HRMS.Model.applets.typeModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HRMS.Model.applets.typeModel model;
