...
namespace HRMS.BLL.applets
{
	...
	{
        private readonly IindustryDAL dal = DataAccess.CreateappindustryDAL();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public HRMS.Model.applets.industryModel GetModelByCache(int id)
        {
            string CacheKey = "applets_industryModel-" + id;
            ...
            return (HRMS.Model.applets.industryModel)objModel;
        }
        
        public HRMS.Model.applets.industryModel GetModelByCache(string strWhere)
        {
            string Array = "-,_,:,/,=,', ,.";
            ...
            string CacheKey = "applets_industryModel-" + _strWhere;
            object objModel = HRMS.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.applets.industryModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.applets.industryModel> DataTableToList(DataTable dt)
        {
            List<HRMS.Model.applets.industryModel> modelList = new List<HRMS.Model.applets.industryModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HRMS.Model.applets.industryModel model;
