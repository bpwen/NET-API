...
namespace HRMS.BLL.applets
{
	...
	{
        private readonly IcustomerDAL dal = DataAccess.CreatecustomerDAL();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public HRMS.Model.applets.customerModel GetModelByCache(int id)
        {
            string CacheKey = "applets_customerModel-" + id;
            ...
            return (HRMS.Model.applets.customerModel)objModel;
        }
        
        public HRMS.Model.applets.customerModel GetModelByCache(string strWhere)
        {
            string Array = "-,_,:,/,=,', ,.";
            ...
            string CacheKey = "applets_customerModel-" + _strWhere;
            object objModel = HRMS.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.applets.customerModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HRMS.Model.applets.customerModel> DataTableToList(DataTable dt)
        {
            List<HRMS.Model.applets.customerModel> modelList = new List<HRMS.Model.applets.customerModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HRMS.Model.applets.customerModel model;
